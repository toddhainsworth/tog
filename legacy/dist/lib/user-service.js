export const UserService = {
     ...
     */
    async performHealthCheck(client, context) {
     ...
     */
    async testConnection(client, context) {
        try {
     ...
     */
    async validateAuthentication(client, context) {
     ...
     */
    async validateToken(client, context) {
        try {
