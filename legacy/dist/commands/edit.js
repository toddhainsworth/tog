...
export default class Edit extends BaseCommand {
    static description = 'Edit the currently running timer';
    static examples = [
    ...
    showCurrentTimer(currentEntry, projects, tasks) {
        this.log('\nCurrent timer:');
    ...
    showUpdateSummary(originalEntry, updatedEntry, projects, tasks) {
        this.log('\nUpdated timer:');
