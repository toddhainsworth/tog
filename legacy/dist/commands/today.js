...
import { aggregateTimeEntriesByProject, calculateElapsedSeconds, formatTimeEntry, getTodayDateRange, } from '../lib/time-utils.js';
export default class Today extends BaseCommand {
    static description = 'Display a comprehensive summary of today\'s time tracking activities';
    static examples = [
